...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/touhou-arrange-chronicle-blitz
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/touhou-arrange-chronicle-blitz_test
```
...
```
touhou-arrange-chronicle-blitz
├── app
│   |── auth
│   │   ├── components
│   │   │   └── LoginForm.tsx
